<div class="home-tab">
                      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        <ul class="nav nav-tabs" role="tablist">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" id="tahfidz-tab" data-bs-toggle="tab" href="#tahfidz" role="tab" aria-selected="false">
                              Tahfidz
                            </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link border-0" id="disclaimer-tab" data-bs-toggle="tab" href="#disclaimer" role="tab" aria-selected="false">
                              Disclaimer
                            </a>
                          </li>
                        </ul>
